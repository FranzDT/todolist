  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="dropdown no-arrow">
                                            ...
                                            <div class="dropdown-header">Todo Actions:</div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <?php  
                                                    if ($row['todo_status'] == 'backlog')
                                                    {
                                                        echo "<a href='../process/todo_progress.php?todoid=". $row['todo_id'] ."' class='btn btn-primary' role='button'>>></a>";
                                                    }
                                                ?>
                                            </div>
                                        </div>
                            ...
                            elseif ($row['todo_status'] == 'progess') 
                            {
                            ?>
                                <div class="col-lg-4">
